...
from datasets.Create_dataset_classes import MetaData, Sample
from datasets.Create_dataset_classes import *
import datasets.Create_dataset_classes as Create_dataset_classes
...
class DataSetBase(Dataset):
    ...
    def __init__(self, root: str, nclasses_existence: int, ndirections: int, is_train: bool, nexamples: int = None,
        ...
        Args:
            ...
            nexamples: The number of classes. used to train only limited part of the dataset
...
class DatasetAllDataSetTypes(DataSetBase):
    def __init__(self, root: str, opts: Union[argparse.ArgumentParser, Config], arg_and_head_index: int = 0, direction: int = 0,
        ...
        if not isinstance(opts, argparse.ArgumentParser):
            full_path = rf"new_revision/datasets/create_config.yaml"
