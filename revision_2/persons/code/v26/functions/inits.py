...
def init_model_options(config: ConfigClass, flag_at, normalize_image, nclasses_existence, ntypes, flag_size,
                       BatchNorm, inshape):
    ...
    if model_opts.flag_at is FlagAt.NOFLAG or model_opts.head_of_all_features:
