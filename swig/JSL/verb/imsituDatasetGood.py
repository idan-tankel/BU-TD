...
class imSituDatasetGood(Dataset):
    def __init__(self, verb_dict, json_file, is_train,image_store_location = './images_512/', inference=False):
    ...
    def __getitem__(self, idx):
        ...
        return {'label_all': data['verb'], 'img': im_tensor , 'frame_length': data['frame_length'], 'roles': data['roles'], 'im_name':  data['image_features'] + '.jpg'}
        # image --> img
        # frame_lenght
