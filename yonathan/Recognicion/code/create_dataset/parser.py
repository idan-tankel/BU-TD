...
def Get_parser(ds_type, nchars_per_row=6, num_rows_in_the_image=1):
    ...
    parser.add_argument('--nsamples_train', default=10,
                        type=int, help='The number of samples in the train set')
    parser.add_argument('--nsamples_test', default=40,
                        type=int, help='The number of samples in the test set')
    parser.add_argument('--nsamples_val', default=40, type=int,
                        help='The number of samples in the val set')
    parser.add_argument('--generalize', default=False, type=bool,
                        help='Whether to create the combinatorial generalization set')
    parser.add_argument('--use_only_valid_classes', default=False,
    ...
    parser.add_argument('--num_characters_per_sample', default=nchars_per_row *
                        num_rows_in_the_image, type=int, help='The number of queries to create for the same image')
    ...
    parser.add_argument('--minscale', default=0.8, type=float,
                        help='The minimal character scale')
    parser.add_argument('--maxscale', default=1.1, type=float,
                        help='The maximal character scale')
    parser.add_argument('--minshift', default=0.0,
                        type=float, help='The minimal shift')
    parser.add_argument('--maxshift', default=0.0,
