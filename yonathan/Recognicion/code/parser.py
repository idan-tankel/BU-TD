...
def Get_parser(ds_type, nchars_per_row = 6, num_rows_in_the_image = 1):
    ...
    parser.add_argument('--path_data_raw_for_omniglot', default='/home/sverkip/data/BU-TD/omniglot/data/omniglot_all_languages/', type=str, help='The Raw data path')
    ...
    parser.add_argument('--num_rows_in_the_image', default = num_rows_in_the_image, type=int, help='The number of rows in the image')
