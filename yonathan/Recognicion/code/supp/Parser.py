...
import argparse
from supp.loss_and_accuracy import UnifiedLossFun, multi_label_accuracy_base, BU2_loss
...
def GetParser(opts , lr = 0.001,wd = 0.00001,language_idx = 0,direction = 'right'):
    """
    Args:
    ...
    parser.add_argument('--bu2_loss', default = BU2_loss, type=Callable, help='The bu2 classification loss')
