...
from avalanche.supp_avalanche_AI.training.supervised.strategy_wrappers import Naive_with_freezing
...
loggers.append(WandBLogger(project_name="Baselines_code", run_name="train",path='/home/sverkip/data/BU-TD/yonathan/Recognicion/data/emnist/results/MyFirstCheckpoint.ckpt'))
