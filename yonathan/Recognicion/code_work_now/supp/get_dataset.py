...
def get_dataset_for_spatial_realtions(args,data_fname, embedding_idx: int,direction:int) -> list:
    ...
    train_ds = dataset(os.path.join(data_fname, 'train'), args.nclasses,args.ndirections, args.ntasks, embedding_idx,direction, args.nargs, nexamples=nsamples_train, split=True)
    ...
    train_ds = dataset(os.path.join(data_fname, 'train'), args.nclasses,args.ndirections, args.ntasks, embedding_idx,direction, args.nargs,
                       nexamples=nsamples_train, split=True, mean_image=mean_image)
    test_ds = dataset(os.path.join(data_fname, 'test'), args.nclasses,args.ndirections, args.ntasks, embedding_idx,direction, args.nargs,
