import argparse
def Get_parser(nchars_per_row = 4, num_rows_in_the_image = 1):
    ...
    parser.add_argument('--store_folder', default='/home/sverkip/data/BU-TD/omniglot/data/samples', type=str,help='The storing path')
  ...
  #  parser.add_argument('--nsamples_train', default = 34000, type=int, help='The number of samples in the train set')
    parser.add_argument('--nsamples_train', default = 140000//(nchars_per_row - 2), type=int, help='The number of samples in the train set')
    ...
    parser.add_argument('--grit_size', default = 4, type=int, help='Number of directions to create from')
    parser.add_argument('--image_size', default = [112, 300], type=list, help='The image size')
    parser.add_argument('--create_all_directions', default=False, type=bool,   help='Whether to create all directions')
    parser.add_argument('--ngenerate', default = nchars_per_row - 2, type=int, help='The number of queries to create for the same image')
    parser.add_argument('--num_rows_in_image', default = num_rows_in_the_image, type=int, help='The number of rows in the image')
    ...
    parser.add_argument('--sample_nchars', default=nchars_per_row * num_rows_in_the_image, type=int,   help='The number of characters in each image')
