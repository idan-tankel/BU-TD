...
class depthwise_separable_conv(nn.Module):
    ...
    def __init__(self, channels_in: int, channels_out: int, kernel_size: int, stride: int = 1, padding: int = 1,
        ...
        self.depthwise = nn.Conv2d(channels_in, channels_out, kernel_size=kernel_size, stride=stride, padding=padding, bias=False)  # Preserves the number of channels but may downsample by stride.
