...
def GetParser(lr , wd, lr_decay):
    ...
    parser.add_argument('--lr_decay', default=lr_decay, type=float, help='Lr decay for the SGD optimizer ')
    ...
    parser.add_argument('--bs', default = 256, type=int, help='The training batch size')
    ...
    parser.add_argument('--cycle_lr', default=False, type=bool, help='Whether to cyclr the lr')
    ...
    parser.add_argument('--base_lr', default=0.001, type=float, help='Base lr of the cyclic Adam optimizer')
    ...
    parser.add_argument('--nfilters', default = [64, 128, 256, 512], type=list, help='The ResNet filters')
    ...
    parser.add_argument('--EPOCHS', default = 24, type=int, help='Number of epochs in the training')
    parser.add_argument('--num_gpus', default=num_gpus, type=int, help='number of used gpus')
    # Change to another function
    ##########################################
    results_dir =  '/home/projects/shimon/sverkip/cifar10/data/trained_models'
    now = datetime.now()
    dt_string = now.strftime("%d.%m.%Y %H:%M:%S")
    model_path = "Model_CIFAR"
    ...
    parser.add_argument('--nclasses', default=[[10]], type=list,
    ...
    parser.add_argument('--task_accuracy', default = classification_accuracy, type=Callable,
