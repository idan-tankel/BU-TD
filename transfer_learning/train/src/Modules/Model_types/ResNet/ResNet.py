...
from ...continual_learning_layers.Batch_norm import BatchNorm as Batch_Norm_ours_with_saving_stats
...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        self.linear = Multi_task_head(in_channels=self.channels[-1], heads=self.heads,
...
class SimpleMLP(nn.Module):
    ...
    def __init__(self, opts):
        ...
        for idx, shape in enumerate(self.shapes[:-2]):
            ...
            layer = Modulated_layer(opts, layer, self.modulations, create_modulation=True,
